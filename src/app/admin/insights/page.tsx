...
export default function AIInsightsPage() {
  ...
  const insights = [
    {
      ...
      description:
        "Platform experiencing 28% month-over-month growth. Predict 600+ users by June 2024.",
      priority: "high",
    ...
    },
    {
      ...
      description:
        "Average approval time increased to 48 hours. Consider adding more admin reviewers.",
      priority: "medium",
    ...
    },
    {
      ...
      description:
        "Users most active between 2-4 PM and 7-9 PM. Schedule important announcements accordingly.",
      priority: "low",
      color: "text-blue-600",
    ...
    },
    {
      ...
      description:
        "Students with complete profiles are 3.2x more likely to receive interview calls.",
      priority: "high",
  ...
  const recommendations = [
    ...
    },
    {
      ...
      action:
        "Introduce points system for profile completion and participation",
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Machine learning-powered platform intelligence
            </p>
          </div>
        </div>
      </motion.div>
      ...
      <Card className="border-2 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/50 dark:to-purple-950/50">
        <CardHeader>
          ...
          <CardDescription>
            AI forecast based on historical patterns and trends
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Strategic actions to improve platform performance
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Top in-demand skills based on job postings and industry trends
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
