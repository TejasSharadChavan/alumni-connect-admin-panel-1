...
import { FolderKanban, Search, Eye, CheckCircle2, XCircle, Clock, Code, ExternalLink } from "lucide-react";
...
export default function ProjectsManagementPage() {
  ...
  const handleApprove = async (projectId: number) => {
    try {
      const token = localStorage.getItem("auth_token");
      const response = await fetch(`/api/project-submissions/${projectId}/review`, {
        method: "POST",
        headers: {
                  ...
                  {loading ? (
                    ...
                    filteredProjects.map((project) => (
                      <TableRow key={project.id}>
                        ...
                        <TableCell className="text-sm">{project.submittedBy}</TableCell>
                        <TableCell>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Team: {selectedProject.teamName} • Submitted by {selectedProject.submittedBy}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <Badge variant={getStatusColor(selectedProject.status)} className="mt-1">
