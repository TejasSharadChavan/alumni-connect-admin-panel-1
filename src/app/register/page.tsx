...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      ...
      (!formData.branch || !formData.cohort)
    ) {
    ...
    if (
      ...
      toast.error(
        "Branch and Year of Passing are required for alumni registration"
      );
      return;
    }
    ...
    try {
      ...
      if (formData.yearOfPassing)
        submittedData.yearOfPassing = parseInt(formData.yearOfPassing);
          ...
          <Card className="border-2 shadow-xl text-center">
            <CardHeader className="space-y-4">
              ...
              <CardDescription className="text-base">
                Your registration has been received and is pending admin
      ...
      >
        <Card className="border-2 shadow-xl">
          <CardHeader className="space-y-3 text-center">
            ...
            <CardDescription className="text-base">
              Join the Terna Engineering College AlumConnect Platform
            </CardDescription>
          </CardHeader>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleChange("requestedRole", value)
                    }
                  >
                    <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="IT Engineering">
                          IT Engineering
                        </SelectItem>
                      </SelectContent>
                    </Select>
            ...
            <CardFooter className="flex flex-col space-y-4">
              ...
              <div className="text-center">
                <p className="text-xs text-muted-foreground bg-amber-500/10 border border-amber-500/20 p-3 rounded-md">
                  ⚠️ <strong>Note:</strong> Your registration will be reviewed
                  by an administrator. You'll receive an email once your account
                  is approved.
                </p>
              </div>
            </CardFooter>
