...
import { Users, Search, Filter, UserPlus, Check, X, Linkedin, Github, MessageSquare, TrendingUp } from "lucide-react";
  ...
  const UserCard = ({ user, showActions = true, showMessageButton = false }: { user: User; showActions?: boolean; showMessageButton?: boolean }) => (
    <Card className="h-full hover:shadow-lg transition-shadow">
      ...
      <CardContent className="space-y-4">
        {user.headline && (
          <p className="text-sm text-muted-foreground line-clamp-2">{user.headline}</p>
        )}
        ...
        >
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Connect with students, fellow alumni, and faculty
            </p>
          </div>
        </motion.div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">New People</p>
                </div>
              </div>
            </CardContent>
          </Card>
