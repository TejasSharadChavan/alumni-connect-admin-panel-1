...
export default function AlumniDonationsPage() {
  ...
  const statsCards = [
    ...
    },
    {
      ...
      value: stats?.userStats.totalDonations ? `₹${stats.userStats.totalDonations.toLocaleString()}` : "₹0",
              ...
              <CardContent className="space-y-4">
                {stats?.recentDonations && stats.recentDonations.length > 0 ? (
                  stats.recentDonations.map((donation) => (
                    <div key={donation.id} className="flex items-start justify-between p-4 rounded-lg border">
          ...
          >
            <Card className="border-2">
              <CardHeader>
                ...
                <CardDescription>Your contributions to the college</CardDescription>
              </CardHeader>
              <CardContent>
