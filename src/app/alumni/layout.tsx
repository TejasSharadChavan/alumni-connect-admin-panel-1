...
export default function AlumniLayout({
  ...
  const navigation = [
    ...
    { name: "Referrals", href: "/alumni/referrals", icon: Share2 },
  ...
  const topNavItems = [
    ...
    { name: "Analytics", href: "/alumni/analytics", icon: TrendingUp },
    { name: "Dashboard", href: "/alumni/analytics-dashboard", icon: BarChart3 },
    { name: "Trends", href: "/alumni/trends", icon: Sparkles },
    {
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    size="icon"
                    className="lg:hidden text-green-600 hover:bg-green-50 hover:text-green-700 relative"
