...
import { GraduationCap, LayoutDashboard, Briefcase, Calendar, Users, MessageSquare, LogOut, Menu, Heart, PlusCircle } from "lucide-react";
...
export default function AlumniLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    { name: "Post Job", href: "/alumni/post-job", icon: PlusCircle },
    { name: "Post Event", href: "/alumni/post-event", icon: Calendar },
        ...
        <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
          <div className="container flex h-16 items-center justify-between px-4">
            <div className="flex items-center gap-4">
              ...
              <Link href="/alumni" className="flex items-center gap-2 font-semibold">
                ...
                <DropdownMenuContent className="w-56" align="end" forceMount>
                  <DropdownMenuLabel className="font-normal">
                    <div className="flex flex-col space-y-1">
                      ...
                      <p className="text-xs font-medium text-green-600 mt-1">Alumni</p>
                    </div>
                  </DropdownMenuLabel>
                  <DropdownMenuSeparator />
